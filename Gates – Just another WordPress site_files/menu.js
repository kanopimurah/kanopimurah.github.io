...
jQuery(document).ready(function(){
	...
	jQuery('.gates-mainmenu-toggle').click(function(){
	jQuery('#gates-page-box').toggleClass('is-mobile-menu');
	jQuery('#gates-mobile-menu').toggleClass('is-mobile-menu');
...
jQuery(window).resize(function () {
	...
	if(typeof $Gates_TABLET_WIDTH != 'undefined') {
		if (jQuery(window).width()> $Gates_TABLET_WIDTH) {
		   jQuery('#gates-page-box').removeClass('is-mobile-menu');
			jQuery('#gates-mobile-menu').removeClass('is-mobile-menu');
